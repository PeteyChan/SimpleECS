  ...
  public partial class Query
  {
       ...
       public void Foreach<C1>(in c1_query<C1> action)
       {
           if (Update(out var world_info))
           {
               ...
               for (int archetype_index = 0; archetype_index < archetype_count; ++archetype_index)
               {
                   ...
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1))
                   {
       ...
       public void Foreach<C1, C2>(in c2_query<C1, C2> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
       ...
       public void Foreach<C1, C2, C3>(in c3_query<C1, C2, C3> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2)&& archetype.TryGetArray(out C3[] c3))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
       ...
       public void Foreach<C1, C2, C3, C4>(in c4_query<C1, C2, C3, C4> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2)&& archetype.TryGetArray(out C3[] c3)&& archetype.TryGetArray(out C4[] c4))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
       ...
       public void Foreach<C1, C2, C3, C4, C5>(in c5_query<C1, C2, C3, C4, C5> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2)&& archetype.TryGetArray(out C3[] c3)&& archetype.TryGetArray(out C4[] c4)&& archetype.TryGetArray(out C5[] c5))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
       ...
       public void Foreach<C1, C2, C3, C4, C5, C6>(in c6_query<C1, C2, C3, C4, C5, C6> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2)&& archetype.TryGetArray(out C3[] c3)&& archetype.TryGetArray(out C4[] c4)&& archetype.TryGetArray(out C5[] c5)&& archetype.TryGetArray(out C6[] c6))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
       ...
       public void Foreach<C1, C2, C3, C4, C5, C6, C7>(in c7_query<C1, C2, C3, C4, C5, C6, C7> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2)&& archetype.TryGetArray(out C3[] c3)&& archetype.TryGetArray(out C4[] c4)&& archetype.TryGetArray(out C5[] c5)&& archetype.TryGetArray(out C6[] c6)&& archetype.TryGetArray(out C7[] c7))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
       ...
       public void Foreach<C1, C2, C3, C4, C5, C6, C7, C8>(in c8_query<C1, C2, C3, C4, C5, C6, C7, C8> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2)&& archetype.TryGetArray(out C3[] c3)&& archetype.TryGetArray(out C4[] c4)&& archetype.TryGetArray(out C5[] c5)&& archetype.TryGetArray(out C6[] c6)&& archetype.TryGetArray(out C7[] c7)&& archetype.TryGetArray(out C8[] c8))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
       ...
       public void Foreach<C1, C2, C3, C4, C5, C6, C7, C8, C9>(in c9_query<C1, C2, C3, C4, C5, C6, C7, C8, C9> action)
       {
           if (Update(out var world_info))
           {
               ...
               {
                   var archetype = world_info.archetypes[matching_archetypes[archetype_index]].data;
                   if (archetype.entity_count > 0 && archetype.TryGetArray(out C1[] c1)&& archetype.TryGetArray(out C2[] c2)&& archetype.TryGetArray(out C3[] c3)&& archetype.TryGetArray(out C4[] c4)&& archetype.TryGetArray(out C5[] c5)&& archetype.TryGetArray(out C6[] c6)&& archetype.TryGetArray(out C7[] c7)&& archetype.TryGetArray(out C8[] c8)&& archetype.TryGetArray(out C9[] c9))
                   {
                       for (int e = 0; e < archetype.entity_count; ++e)
